package com.hopper.project.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.hopper.project.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"Esta API é utilizada no estudo de caso apresentado pelo Prof. Nelio Alves na Udemy",
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact(
						"Anderson Kistner",
						"https://github.com/akistner/spring_boot_ionic_backend",
						"anderson.kistner@gmail.com"),
