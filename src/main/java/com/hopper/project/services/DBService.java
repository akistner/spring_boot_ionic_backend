...
import com.hopper.project.domain.Endereco;
import com.hopper.project.domain.Estado;
import com.hopper.project.domain.ItemPedido;
import com.hopper.project.domain.Pagamento;
import com.hopper.project.domain.PagamentoComBoleto;
import com.hopper.project.domain.PagamentoComCartao;
import com.hopper.project.domain.Pedido;
import com.hopper.project.domain.Produto;
import com.hopper.project.domain.enums.EstadoPagamento;
import com.hopper.project.domain.enums.Perfil;
...
import com.hopper.project.repositories.EnderecoRepository;
import com.hopper.project.repositories.EstadoRepository;
import com.hopper.project.repositories.ItemPedidoRepository;
import com.hopper.project.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "anderson.kistner@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana.costa@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		cat1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21,
												...
												p32, p34, p35, p36, p37, p38, p39, p40, p41, p42,
